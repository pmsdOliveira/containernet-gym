...
class ContainernetEnv(Env):
    def __init__(self):
        ...
        self.state = [0, 0, 0, 0, 0.0, 0.0]  # (n_elastic, n_inelastic, (type, duration, bw, price/t))

        self.requests_queue = Queue()
        self.requests = 0
        self.max_requests = 16

        self.generator_threads_semaphore = False
    ...
    def reset(self) -> object:
        ...
        self.requests_queue = Queue()
        self.requests = 0
        self.generator_threads_semaphore = True
    ...
    def request_generator(self, type: int) -> None:
        ...
        while self.generator_threads_semaphore:
